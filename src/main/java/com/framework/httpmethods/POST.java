...
public class POST extends TestBase {
	...
	public void response_field_validations(String url,String body, String path, String expected) {
		...
		String actual = given().header("Content-Type", "application/json").header("Accept", "application/json").when().body(body).post(url).jsonPath().get(path);
	...
	public void response_body_validations(String url, String body, String expected) {
		...
		String actual = given().header("Content-Type", "application/json").header("Accept", "application/json").when().body(body).post(url).asString();
	...
	public void response_status_code_validations(String url,String body, String expected) {
		...
		int actual = given().header("Content-Type", "application/json").header("Accept", "application/json").when().body(body).post(url).getStatusCode();
	...
	public void response_header_validations(String url,String body, String expected) {
		...
		String actual = given().header("Content-Type", "application/json").header("Accept", "application/json").when().body(body).post(url).getHeader("Content-Type");
	...
	public void response_time_validations(String url,String body, long expected) {
		...
		long actual = given().header("Content-Type", "application/json").header("Accept", "application/json").when().body(body).post(url).getTime();
